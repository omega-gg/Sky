...
public: // Enums
    ...
    enum TrackType { TrackUnknown, TrackMedia, TrackLive, TrackHub, TrackChannel };
...
public: // Interface
    Q_INVOKABLE int addTrack (const WTrack        & track);
    Q_INVOKABLE int addTracks(const QList<WTrack> & tracks);
    ...
    Q_INVOKABLE bool trackIsLite       (int index) const;
