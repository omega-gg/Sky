...
Qt5_ubuntu="qt5-default qtdeclarative5-dev qtbase5-private-dev qtdeclarative5-private-dev "\
"qtscript5-dev libqt5xmlpatterns5-dev libqt5svg5-dev libqt5x11extras5-dev"
