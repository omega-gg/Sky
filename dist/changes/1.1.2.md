...
- Slider stream: Removed wheel input.
...
- Created Button push overlay.

- Created Line edit box.

- Window: Updated the border size.

- Icons: Updated the color.

- Scroll bar: Removed the handle icon.

- Player browser: Updated buttons to ButtonPushIcon.
