...
- Create Panel, PanelContextual, PanelContextualFlickable.

- Create BaseButtonTouch, ButtonTouch, ButtonTouchLeft, ButtonTouchIcon, ButtonTouchFull.

- Create ButtonContextual, ButtonContextualFull.

- Create BaseLabel, Label, LabelIcon, LabelLoading, LabelContextual.

- Create LineEdit.

- Create ColumnContextual.
