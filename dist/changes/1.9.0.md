...
- WControllerPlaylist: Add the 'vbmlTypePlaylist' function.
...
- WControllerPlaylist: Update the 'urlIsVbmlRun' function.

- WControllerPlaylist: Update the 'urlIsVbmlConnect' function.
...
- WBackendLoaderCache: Create the 'insertId' function.

- WPixmapCache: Create the 'read' function.
