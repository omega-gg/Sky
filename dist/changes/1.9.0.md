...
- WControllerApplcation/mobile: Add the 'share' function(s).

- WControllerApplcation/mobile: Add the 'imageSelected' signal.

- WControllerApplcation/mobile: Add the 'shareFinished' signal.

- WControllerApplcation/mobile: Update native functions to static.
...
- WDeclarativeMouseArea: Update 'mousePressEvent' event.
