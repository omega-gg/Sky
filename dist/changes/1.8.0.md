...
- WControllerApplication: Add the 'insertLine(s)' functions.

- WControllerApplication: Add the 'removeLine(s)' functions.
...
- WPlaylist: Add the 'reload(s)' functions.
...
- WPlaylist: Add the 'Track(s)' enums.
...
- ListPlaylist: Add the 'reload' implementation.
